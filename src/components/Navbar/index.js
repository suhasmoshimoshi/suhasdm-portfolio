      ...
      <NavbarContainer id="nav-menu">
        <NavLogo to='/'>
          <div style={{ display: "flex", alignItems: "center", color: "white", marginBottom: '20', cursor: 'pointer' }}>
            <DiCssdeck size="3rem" /> <Span>Suhas</Span>
          </div>
        </NavLogo>
        <MobileIcon>
          <FaBars onClick={() => {
        ...
        <NavItems>
          ...
          <ButtonContainer id="resume-button-1" >
            <ResumeButton id="resume-link-1" className='nav-link resume' href={Shubham} target="_blank" download="SUHASDM.pdf" rel="noopener noreferrer" onClick={handleResumeButtonClick}>Resume</ResumeButton>
          </ButtonContainer>
        </NavItems>
